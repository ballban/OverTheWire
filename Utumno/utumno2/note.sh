mkdir /tmp/utumno2_ballban
cd /tmp/utumno2_ballban

# Create utumno2_execv.c and compile it
# It will run utumno2 with null argv
nano utumno2_execv.c
gcc -m32 utumno2_execv.c -o utumno2_execv
